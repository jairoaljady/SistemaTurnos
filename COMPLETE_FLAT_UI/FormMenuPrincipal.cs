...
namespace COMPLETE_FLAT_UI
{
    public partial class FormMenuPrincipal : Form
    {
        ...
        {
            FormMantCliente fm = new FormMantCliente();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);

            /*Si quiero que salga la lista de la consulta
        ...
        {
            Form_Mostrar_Turnos turno = new Form_Mostrar_Turnos();
            turno.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(turno);
        }
        ...
        {
            login tk = new login();
            tk.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(tk);
        }

        private void button6_Click(object sender, EventArgs e)
        {
            desarrolladores dev_form= new desarrolladores();
            dev_form.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(dev_form);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            simulador simulador_form = new simulador();
            simulador_form.Show();
        }
