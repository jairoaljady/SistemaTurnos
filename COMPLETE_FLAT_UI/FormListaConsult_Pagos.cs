...
{
    public partial class FormListaConsult_Pagos : Form
    {
        int poc2;
        public FormListaConsult_Pagos(string nombre)
        {
            InitializeComponent();
            label1.Text = nombre;
        }
        ...
        private void FormListaConsult_Pagos_Load(object sender, EventArgs e)
        {
            Cargar();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            poc2 = dataGridView1.CurrentRow.Index;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd2.CommandText = "DELETE FROM pagos WHERE TURNO=@ID";
