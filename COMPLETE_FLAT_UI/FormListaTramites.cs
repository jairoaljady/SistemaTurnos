...
{
    public partial class FormListaTramites : Form
    {
        public FormListaTramites(string nombre)
        {
            InitializeComponent();
            label1.Text = nombre;
        }
        ...
        private void FormListaTramites_Load(object sender, EventArgs e)
        {
            Cargar();
        }
        void limpiar()
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd2.CommandText = "DELETE FROM tramites WHERE TURNO=@ID";
